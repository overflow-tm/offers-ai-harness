...
> このスキルはプロフィール情報と求人データを Offers MCP サーバーに送信して年収相場を算出します。Offers 側ではセッション終了後にデータを保持しません。なお、AI エージェント側でのデータの取り扱いは、ご利用中のツールのプライバシーポリシーに従います。
...
- 出力末尾に「※ Offers 側ではセッション終了後にデータを保持しません」の注記を含める
